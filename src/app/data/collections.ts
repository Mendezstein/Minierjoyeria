...
/*
 * Para usar las fotos reales del taller: guarda cada foto en formato .webp
 * dentro de public/images/ y reemplaza la url por la ruta local,
 * por ejemplo:  url: "/images/anillo-solitario.webp"
 */
export const COLLECTIONS: Record<CollectionId, GalleryItem[]> = {
  anillos: [
    { url: "https://images.unsplash.com/photo-1589674668791-4889d2bba4c6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Anillo solitario de platino con diamante brillante", label: "The Blanc Solitaire", category: "Anillos de Compromiso", width: 800, height: 800 },
    ...
    { url: "https://images.unsplash.com/photo-1640405172860-076f1ef62ea5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Anillo de compromiso con zafiro ovalado en oro amarillo", label: "Royal Sapphire Set", category: "Gemas de Color", width: 800, height: 800 },
    { url: "https://images.unsplash.com/photo-1613945407943-59cd755fd69e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Anillo halo de diamantes en oro rosa sobre terciopelo", label: "The Crimson Halo", category: "Anillos de Compromiso", width: 800, height: 800 },
    ...
    { url: "https://images.unsplash.com/photo-1677045419454-e8b201856472?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Solitario oval en oro amarillo 18k", label: "Solitario Oval", category: "Alta Joyería", width: 800, height: 800 },
  ],
  compromiso: [
    { url: "https://images.unsplash.com/photo-1518370265276-f22b706aeac8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Anillo de compromiso con diamante sobre rosas rojas", label: "Promesa de Rosas", category: "Anillos de Compromiso", width: 800, height: 800 },
    { url: "https://images.unsplash.com/photo-1512163143273-bde0e3cc7407?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Anillo de compromiso en estuche de presentación", label: "Estuche Nupcial", category: "Anillos de Compromiso", width: 800, height: 800 },
    { url: "https://images.unsplash.com/photo-1677045419454-e8b201856472?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Primer plano de anillo de compromiso en estuche", label: "Detalle Solitario", category: "Anillos de Compromiso", width: 800, height: 800 },
    { url: "https://images.unsplash.com/photo-1613945409199-1b5527d31fe8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Anillo de diamante sobre textil rojo terciopelo", label: "Diamante Carmesí", category: "Anillos de Compromiso", width: 800, height: 800 },
  ],
  arretes: [
    { url: "https://images.unsplash.com/photo-1701777892770-df3bf8006fd8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Par de aretes sobre tela blanca", label: "Aretes Clásicos", category: "Joyería de Oído", width: 800, height: 800 },
    ...
    { url: "https://images.unsplash.com/photo-1626784215021-2e39ccf971cd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=800", alt: "Aretes de oro y plata sobre superficie negra", label: "Duo Metálico", category: "Colección Bicolor", width: 800, height: 800 },
